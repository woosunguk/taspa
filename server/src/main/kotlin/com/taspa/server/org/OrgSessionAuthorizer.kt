...
enum class OrgConsoleSurface(
    ...
    ABSENCE("부재 관리는 세션 인증에서만 가능합니다", "이 조직의 부재 기록을 관리할 권한이 없습니다"),
    CALENDAR("캘린더 관리는 세션 인증에서만 가능합니다", "이 조직의 캘린더를 관리할 권한이 없습니다"),
    MEAL_MENU("식단 관리는 세션 인증에서만 가능합니다", "이 조직의 식단을 관리할 권한이 없습니다"),
}
